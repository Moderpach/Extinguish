...
object SurfaceControlProxy {
    ...
    @Deprecated(
        message = "Removed since Android 14.",
        ReplaceWith(
            "DisplayControlProxy.getPhysicalDisplayToken()",
            "extinguish.hiddenAPI.server.display"
        )
    )
    ...
    @Deprecated(
        ...
        ReplaceWith(
            "SurfaceControlProxy.getInternalDisplayToken()",
            "extinguish.hiddenAPI.view"
        )
    )
